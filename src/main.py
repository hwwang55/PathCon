...
parser.add_argument('--dim', type=int, default=4, help='hidden dimension of relation embeddings')
...
parser.add_argument('--finetune', type=bool, default=False, help='whether to fin tune bert features')
